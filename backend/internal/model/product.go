...
type ProductIngredient struct {
	ID           string    `gorm:"type:uuid;default:gen_random_uuid();primaryKey" json:"id"`
	ProductID    string    `gorm:"type:uuid;not null;uniqueIndex:idx_product_ingredient" json:"product_id"`
	IngredientID string    `gorm:"type:uuid;not null;uniqueIndex:idx_product_ingredient" json:"ingredient_id"`
...
type ProductOption struct {
	ID            string    `gorm:"type:uuid;default:gen_random_uuid();primaryKey" json:"id"`
	GroupID       string    `gorm:"type:uuid;not null;uniqueIndex:idx_option_group_name" json:"group_id"`
	ProductID     string    `gorm:"type:uuid;not null;index" json:"product_id"`
	Name          string    `gorm:"type:varchar(100);not null;uniqueIndex:idx_option_group_name" json:"name"`
	IngredientID  *string   `gorm:"type:uuid" json:"ingredient_id"`
