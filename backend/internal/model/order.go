...
type Order struct {
	...
	// Ghi lại khuyến mãi đã áp dụng. Báo cáo hiệu quả khuyến mãi truy vấn cột
	// này; trước đây cột không tồn tại nên báo cáo luôn trả 500.
	PromotionID   *string        `gorm:"type:uuid;index" json:"promotion_id"`
