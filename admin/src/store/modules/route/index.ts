...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  function getGlobalMenus(routes: ElegantConstRoute[]) {
    menus.value = groupVnetMenus(getGlobalMenusByAuthRoutes(routes));
  }
  ...
  function initStaticAuthRoute() {
    ...
    if (authStore.isStaticSuper) {
      ...
      const filteredAuthRoutes = filterAuthRoutesByRoles(staticAuthRoutes, authStore.roles);
  ...
  async function onRouteSwitchWhenLoggedIn() {
    // no-op: userInfo already loaded via initAuthRoute on first load
  }
