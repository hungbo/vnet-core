...
const local: App.I18n.Schema = {
  ...
  route: {
    ...
    vnet_machines: 'Máy',
    'vnet_machines-detail': 'Chi tiết máy',
  ...
  vnetPages: {
    ...
    members: {
      ...
      resetPasswordConfirm: 'Mật khẩu mới sẽ được tạo ngẫu nhiên. Tiếp tục?',
      resetPasswordResult: 'Mật khẩu mới của hội viên:',
      copy: 'Sao chép',
    ...
    chat: {
      ...
      messages: {
        ...
        loadConversationsError: 'Lỗi tải hội thoại',
