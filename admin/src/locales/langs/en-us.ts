...
const local: App.I18n.Schema = {
  ...
  route: {
    ...
    'vnet_machines-detail': 'Machine Detail',
  ...
  vnetPages: {
    ...
    members: {
      ...
      resetPasswordConfirm: 'A new random password will be generated. Continue?',
      resetPasswordResult: 'New member password:',
      copy: 'Copy',
      copySuccess: 'Copied',
      cash: 'Cash',
      transfer: 'Transfer',
    ...
    chat: {
      ...
      messages: {
        ...
        loadConversationsError: 'Error loading conversations',
