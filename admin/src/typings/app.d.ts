...
declare namespace App {
  ...
  namespace I18n {
    ...
    type LangType = 'en-US' | 'zh-CN' | 'vi-VN';
      ...
      vnetPages: {
        ...
        products: {
          ...
          messages: {
            ...
            loadError: string;
            saveError: string;
            addIngredientSuccess: string;
            deleteIngredientSuccess: string;
            stockInSuccess: string;
            stockOutSuccess: string;
