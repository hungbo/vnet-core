...
/**
 * Hide non-VNET menus by setting hideInMenu on top-level routes that are not 'vnet'
 */
function hideNonVnetMenus(routes: ElegantRoute[]) {
...
export function createStaticRoutes() {
  ...
  return {
    constantRoutes: hideNonVnetMenus(constantRoutes),
    authRoutes: hideNonVnetMenus(authRoutes)
  };
}
